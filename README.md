...
Performance: The CNN with the Swin Transformer reached an overall accuracy of around 92%, with the ability to generate confidence scores for each of the 16 tumor classes.
